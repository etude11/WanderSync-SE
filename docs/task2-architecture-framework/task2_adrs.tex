...
\begin{figure}[H]
  ...
  \fbox{\parbox{0.85\textwidth}{\centering\vspace{1em}
    \textit{Figure placeholder: generate \texttt{adr001\_event\_driven.png} from PlantUML source
    in \texttt{diagrams/adr001\_event\_driven.puml}}
  \vspace{1em}}}
...
\begin{figure}[H]
  ...
  \fbox{\parbox{0.85\textwidth}{\centering\vspace{1em}
    \textit{Figure placeholder: generate \texttt{adr002\_api\_gateway.png} from PlantUML source
    in \texttt{diagrams/adr002\_api\_gateway.puml}}
  \vspace{1em}}}
...
\begin{figure}[H]
  ...
  \fbox{\parbox{0.85\textwidth}{\centering\vspace{1em}
    \textit{Figure placeholder: generate \texttt{adr003\_adapter.png} from PlantUML source
    in \texttt{diagrams/adr003\_adapter.puml}}
  \vspace{1em}}}
...
\begin{figure}[H]
  ...
  \fbox{\parbox{0.85\textwidth}{\centering\vspace{1em}
    \textit{Figure placeholder: generate \texttt{adr004\_jwt\_auth.png} from PlantUML source
    in \texttt{diagrams/adr004\_jwt\_auth.puml}}
  \vspace{1em}}}
