  ...
  theme: {
    extend: {
      ...
      animation: {
        ...
        'reveal-left':'revealLeft 0.65s cubic-bezier(0.16,1,0.3,1) both',
      ...
      keyframes: {
        ...
        reveal:     { from: { opacity: '0', transform: 'translateY(40px)' },  to: { opacity: '1', transform: 'translateY(0)' } },
        revealLeft: { from: { opacity: '0', transform: 'translateX(-32px)' }, to: { opacity: '1', transform: 'translateX(0)' } },
